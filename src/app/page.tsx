  ...
  return (
    <div className="flex flex-col gap-4 justify-center w-[90%] mx-auto">
      <p>
        ...
        I&apos;m always learning and I enjoy working across the stack. I started
        at Complete in August 2023, and have worked on every aspect of our stack
        and product offerings. Previously I worked at a startup in Berkeley
        called{" "}
        <a
          target="_blank"
      ...
      <p>
        ...
        have always enjoyed tinkering, modifying, breaking, and sometimes fixing
        things. My first job was an internship where I spent a summer doing IT
        Helpdesk Support. This was a challenging and truly formative experience
        for me, and laid a foundation for the customer-focused career I lead
        today. Empathy is a hugely underrated skill in engineering.
      </p>
      <p>
